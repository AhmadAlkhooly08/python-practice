...
if answer == 'swim':
   print('You swam acrross and were eaten by an alligator.')
    ...
    answer=input('You walked for many miles, an you been tared And you found a very scary house. Will you stay there or continuo?')
if answer == 'stay':
   print('you couldnt move there from fear, and you lost')    
if answer == 'continuo':
   print('You died of cold and lost')  
if answer == "right":
